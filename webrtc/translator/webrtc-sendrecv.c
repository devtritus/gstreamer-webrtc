...
start_pipeline (void)
{
  ...
  pipe1 = 
      ...
      " rtspsrc user-id=admin user-pw=1236987q location=rtsp://192.168.1.108:554/cam/realmonitor?channel=1&subtype=0 ! rtph264depay ! decodebin ! x264enc ! rtph264pay ! application/x-rtp,media=video,encoding-name=H264,payload=96 ! sendrecv. ",
      &error);
