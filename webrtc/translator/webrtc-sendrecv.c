...
start_pipeline (void)
{
  ...
  pipe1 = 
      ...
      " rtspsrc user-id=admin user-pw=Barco1984 location=rtsp://172.17.13.212:554/cam/realmonitor?channel=1&subtype=0 ! queue ! application/x-rtp, media=video, encoding-name=H264, payload=96 ! sendrecv. ",
      &error);
